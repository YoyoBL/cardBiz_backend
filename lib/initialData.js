...
async function initialize() {
   ...
   if (users.length !== 3) {
      ...
      await User.create(initialUsers).then(() =>
         console.log(chalk.bgBlue("Initial users created"))
      );
   }
   ...
   if (cards.length !== 3) {
      ...
      await Card.create(initialCards).then((data) =>
         console.log(chalk.bgBlue("Initial cards created"), data)
      );
   }
}
